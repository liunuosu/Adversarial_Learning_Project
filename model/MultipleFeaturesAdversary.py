...
class MultipleFeaturesAdversary(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, x_train, y_train):
        ...
        starter_learning_rate_classifier = 0.010
        # 0.1 worked well for constant learning_rate_adversary with InversetimeDecay for classifier
        starter_learning_rate_adversary = 0.010
        starter_learning_rate_multiple = 0.010
