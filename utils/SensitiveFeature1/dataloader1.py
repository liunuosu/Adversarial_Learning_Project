...
def dataloader1(validation=False, random_state=42):
    ...
    if validation:
        dataset_train, dataset_validation, target_train, target_validation = train_test_split(
            dataset_train, target_train, test_size=0.2, random_state=random_state,
            stratify=target_train[['gender']])
