...
def dataloader2():
        ...
        data_train.replace(to_replace=[' White', ' Asian-Pac-Islander', ' Amer-Indian-Eskimo', ' Other', ' Black'],
                           value=['White', 'Minority', 'Minority', 'Minority', 'Minority'], inplace=True)

        data_test.replace(to_replace=[' White', ' Asian-Pac-Islander', ' Amer-Indian-Eskimo', ' Other', ' Black'],
                           value=['White', 'Minority', 'Minority', 'Minority', 'Minority'], inplace=True)
